...
public class EntityPebble extends Entity implements IProjectile
{
    ...
    /** 1 if the player can pick up the pebble */
    public int canBePickedUp = 0;

    /** Seems to be some sort of timer for animating an pebble. */
    public int arrowShake = 0;

    /** The owner of this pebble. */
    public Entity shootingEntity;
    private int ticksInGround;
    private int ticksInAir = 0;
    private double damage = 2.0D;

    /** The amount of knockback an pebble applies when it hits a mob. */
    ...
    public EntityPebble(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        ...
        startLogger();
        logger.info("c'tor()4 complete");
}

    private void startLogger() {
    		if (logger == null){
    	        logger = new StandardLogger("EntityPebble");
    		}
    }
    ...
    public void setThrowableHeading(double par1, double par3, double par5, float par7, float par8)
    {
        ...
        logger.info("setThrowableHeading");
    }
    ...
    public void setPositionAndRotation2(double par1, double par3, double par5, float par7, float par8, int par9)
    {
        ...
        logger.info("setPositionAndRotation2");
    }
    ...
    public void onUpdate()
    {
        ...
        if (var16 > 0)
        {
            logger.debug("OnUpdate var16 " + var16);
        ...
        if (this.inGround)
        {
            logger.debug("OnUpdate inGround");
        ...
        else
        {
                ...
                if (var4.entityHit != null)
                {
                    ...
                    if (var4.entityHit.attackEntityFrom(var21, var23))
                    {
                        if (var4.entityHit instanceof EntityLiving)
                        {
                            ...
                            {
                            		// Pebbles don't stick in players like arrows do
            ...
            {
                logger.debug("spawnParticle crit var9 " + var9);
                ...
                // logger.debug("spawnParticle('crit', posX " + this.posX + ", motionX " + this.motionX + ", var9 " + var9 +
                //				 				   ", posY " + this.posY + ", motionY " + this.motionY + 
                	//   							   ", posZ " + this.posZ + ", motionZ " + this.motionZ);
            }
            ...
            if (this.isInWater())
            {
                ...
                {
                    var26 = 0.25F;
                    logger.debug("spawnParticle bubble var25" + var25);
...
//            }
//        }
        logger.info("onCollideWithPlayer");
}
    ...
    {
        logger.info("getShadowSize");
        return 0.0F;
    }

    public void setDamage(double par1)
    {
        logger.info("setDamage");
        this.damage = par1;
    }

    public double getDamage()
    {
        logger.info("getDamage");
        return this.damage;
    }
    ...
    public void setKnockbackStrength(int par1)
    {
        ...
        logger.info("setKnockbackStrength");
    }
